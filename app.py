...
home_btn = st.selectbox('Choose how to get cigar recommendations:',['Instructions','Enter Favorite Cigar Name', 'Enter Favorite Cigar Profile', 'Match Cigar to Whisky', 'Match Whisky to Cigar',' '], index=5)
